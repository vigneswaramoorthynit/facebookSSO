package com.app.facebookloginaddon.jalo;
...
import com.app.facebookloginaddon.constants.FacebookloginaddonConstants;



/**
 * This is the extension manager of the Facebookloginaddon extension.
 */
public class FacebookloginaddonManager extends GeneratedFacebookloginaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacebookloginaddonManager.class.getName());
	 ...
	 */
	public static FacebookloginaddonManager getInstance()
	{
		return (FacebookloginaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacebookloginaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookloginaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacebookloginaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacebookloginaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacebookloginaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
