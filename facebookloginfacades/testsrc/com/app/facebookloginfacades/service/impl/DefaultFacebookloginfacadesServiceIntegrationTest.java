...
import com.app.facebookloginfacades.service.impl.DefaultFacebookloginfacadesService;
 ...
 */
@IntegrationTest
public class DefaultFacebookloginfacadesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "facebookloginfacadesPlatformLogo";

		// when
		final String logoUrl = facebookloginfacadesService.getHybrisLogoUrl(logoCode);
