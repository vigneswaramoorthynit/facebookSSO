...
/**
 * This is the extension manager of the Facebookloginfacades extension.
 */
public class FacebookloginfacadesManager extends GeneratedFacebookloginfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(FacebookloginfacadesManager.class);
	 ...
	 */
	public static FacebookloginfacadesManager getInstance()
	{
		return (FacebookloginfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FacebookloginfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacebookloginfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of FacebookloginfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of FacebookloginfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of FacebookloginfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
