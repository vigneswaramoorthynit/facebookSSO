...
public class DefaultFacebookloginfacadesService implements FacebookloginfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultFacebookloginfacadesService.class);
	...
	{
		return DefaultFacebookloginfacadesService.class.getResourceAsStream("/facebookloginfacades/sap-hybris-platform.png");
	}
